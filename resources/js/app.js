...
async function consultarAPI() {
    try {
        const e = "http://127.0.0.1:8000/api/servicios",
            t = await fetch(e);
        mostarServicios(await t.json());
    } catch (e) {
        console.log(e);
    }
}
function mostarServicios(e) {
    e.forEach((e) => {
        const { id: t, nombre: o, precio: a } = e,
            n = document.createElement("P");
        n.classList.add("nombre-serivicio"), (n.textContent = o);
...
async function reservarCita() {
    ...
    try {
        const e = "http://127.0.0.1:8000/api/citas",
